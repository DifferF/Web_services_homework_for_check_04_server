...
public class CarJDBCDao implements CarDAO {
    ...
    public void add(Car car) {
        ...
        try {
            ...
            statement = connection.prepareStatement("INSERT INTO cars(mark, model, price) VALUES (?, ?, ?)");
    ...
    public Car getById(int id) {
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("SELECT * FROM cars WHERE id_cars = ? ");
    ...
    public void updatePrice(int price, int carId) {
        ...
        try {
            preparedStatement = connection.prepareStatement("UPDATE cars SET price = ? WHERE id_cars = ?");
    ...
    public void remove(String mark) {
        ...
        try {
          ...
          //  int markId = getMarkId(mark, connection);
            preparedStatement = connection.prepareStatement("DELETE FROM cars WHERE mark = ? ");
